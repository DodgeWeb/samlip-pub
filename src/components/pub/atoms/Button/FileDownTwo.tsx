...
interface FileDownTwoProps {
    className?: string;
    onClick?: () => void;
    text?: string;
}

const FileDownTwo: React.FC<FileDownTwoProps> = ({ 
    className = '',
    onClick,
    ...
    return (
        <button 
            onClick={onClick}
            className={`
                flex items-center lg:justify-center gap-1 lg:gap-2 w-[320px] lg:w-auto h-12 lg:h-20  border border-[#D9D9D9] text-black
